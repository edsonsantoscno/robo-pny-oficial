...
# Conecta estritamente no subdomínio do seu banco de dados Supabase
...
# Roteia os sinais estritamente através do subdomínio do robô (Porta 443 HTTPS do Traefik)
WEBSOCKET_HOST = os.getenv("WS_HOST", "dashboard.mandacarurn.com.br")
WEBSOCKET_PORT = int(os.getenv("WS_PORT", 443))  
