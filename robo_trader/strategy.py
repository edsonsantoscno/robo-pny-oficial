...
class AgressiveStrategy:
    ...
    def calculate_signal(self, df):
        try:
            if df is None or len(df) < 100: # Aumentado limite de segurança para suportar EMA 100
                return "HOLD"
            ...
            if bb is not None and stoch is not None and not bb.empty and not stoch.empty:
                # Mapeamento estrito por nome de coluna técnica do pandas-ta
                ...
                # Fallback de segurança por índice posicional caso os nomes variem na versão
                ...
                # Lógica PNY: Fechamento fora/dentro com confirmação do oscilador
            ...
            # --- SELETOR DE RETORNO DA ESTRATÉGIA ---
